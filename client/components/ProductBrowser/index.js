...
import {pathToProductGroup} from '../../../common/apollo/ProductGroup';
    ...
    render(){
        ...
        return (
            <div className="layout fullheight">
                ...
                <CreateProductDialog ParentGroupId={pProps.parentGroupId} open={this.state.createNew} onComplete={()=>{this.setState({createNew:false});}} onReject={()=>{this.setState({createNew:false});}}/>
            </div>
        );
    }
}
