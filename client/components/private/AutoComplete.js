                ...
                case 'object':
                    ...
                    if (item && typeof item[this.props.dataSourceConfig.text] === 'string') {
                        ...
                        if (itemValue.type && (itemValue.type.muiName === MenuItem.muiName ||
                            ...
                            let avator = null;
                            if(this.props.dataSourceConfig.avator && typeof item[this.props.dataSourceConfig.avator] === 'string' && item[this.props.dataSourceConfig.avator])
                                avator = item[this.props.dataSourceConfig.avator];
                            requestsList.push({
                                text: itemText,
                                value: this.props.dataSourceConfig.secondaryText?
                                    (
                                        <MenuItem style={{lineHeight:'normal'}} key={index}>
                                            <CardHeader title={itemText} subtitle={secondaryText} avatar={avator}/>
                                        </MenuItem>
                                    )
                                    :(
                                    <MenuItem
