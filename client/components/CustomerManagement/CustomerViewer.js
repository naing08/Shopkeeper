...
import {customerByIdQuery} from '../../../common/apollo/Customer/index';
    ...
    renderAppBar(title){
        ...
        if(CustomerById){
            ...
            if(UserAccountId && !UserName){
                accountActionButtons.push(<IconButton key="reactivateAccount" touch={true} tooltip="Reactivate Account"><ActionLockOpen color={white}/></IconButton>);
            }
            else if(UserAccountId && UserName){
                accountActionButtons.push(<IconButton key="changePassword" touch={true} tooltip="Change Password"><CommunicationKey color={white}/></IconButton>);
                accountActionButtons.push(<IconButton key="deactivateAccount" touch={true} tooltip="Deactivate Account"><ActionLock color={white}/></IconButton>)
            }
            else{
                accountActionButtons.push( <IconButton key="createAccount" touch={true} tooltip="Create Account"><CommunicationKey color={white}/></IconButton>);
            }
        }
